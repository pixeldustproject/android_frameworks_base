...
public class DozeService extends DreamService {
    ...
    private void updateDozeSettings() {
        ...
        mDozeTriggerNotification = (Settings.System.getIntForUser(resolver,
                ...
                UserHandle.USER_CURRENT) == 1);
        mDozeTriggerTilt = (Settings.System.getIntForUser(resolver,
        ...
        mDozeTriggerDoubleTap = (Settings.System.getIntForUser(resolver,
                ...
                UserHandle.USER_CURRENT) == 1);
        mDozeTriggerHandWave = (Settings.System.getIntForUser(resolver,
                Settings.System.DOZE_TRIGGER_HAND_WAVE, 1,
                UserHandle.USER_CURRENT) == 1);
        mDozeTriggerPocket = (Settings.System.getIntForUser(resolver,
